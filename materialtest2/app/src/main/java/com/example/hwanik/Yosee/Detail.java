...
public class Detail extends ActionBarActivity implements SensorEventListener,GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            kakaoLink = KakaoLink.getKakaoLink(Detail.this);
...
//                }
        ...
        Toast.makeText(this,"데이터 전송 성공",Toast.LENGTH_SHORT).show();
    }
    ...
    public void onClick(View view) throws KakaoParameterException {
        switch(view.getId()){
            case R.id.like_btn:
                like();
                break;
...
//                commentTv.setText(String.valueOf(commentCnt));
    ...
    private void share() throws KakaoParameterException {
        String imageSrc = "http://navercom";
        int width = 300;
        int height = 300;
